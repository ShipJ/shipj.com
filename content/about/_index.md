---
title: "About"
meta_title: "About Jack Shipsmith"
...
###### Related work
I worked in a range of problem spaces, but one theme was consistent: turn ambiguous data into reliable insights.
- [Computer vision](/shipj.com/blog/?tags=machine-learning)
- [Fraud detection](/shipj.com/blog/?tags=fraud)
- [Search](/shipj.com/blog/?tags=search)
- [Churn](/shipj.com/blog/?tags=churn) and lifetime-value modelling
- [Time-series](/shipj.com/blog/?tags=time-series) forecasting
- Large-scale data [migration](/shipj.com/blog/?tags=migration)
...
The best engineers and data scientists I've worked with:

- Run towards hard problems
- Understand _why_ before acting
- Fix problems permanently
- Leave things better than they found them
- Communicate clearly, often, and adapted to their audience
- Invest in people around them

###### Rules to live by

- Impact over elegance
- Simplicity over complexity
- Long-term maintainability > short-term optimisation

## Side projects

My GitHub portfolio spans hands-on work across personal projects, ML modelling, analytics, and tutorials, often with  an emphasis on turning experimental side projects into working systems.
