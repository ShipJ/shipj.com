...
features:
  ...
  - title: "Demand Forecasting & Predictive Analytics"
    ...
    content: "Anticipate demand, optimize inventory, and reduce costs with machine learning models tailored to your business. I build forecasting solutions that adapt to seasonality, trends, and market shifts."
    bulletpoints:
      - "**Time-series forecasting** using ARIMA, Prophet, and LSTMs for accurate predictions"
      - "**Scenario planning** to model best-case, worst-case, and most-likely outcomes"
      - "**Real-time monitoring** with automated alerts when actuals diverge from forecasts"
      - "**Integration with existing tools** like ERP systems, warehouses, and BI platforms"
    button:
      enable: true
      label: "See my work"
      link: "/portfolio/"
  ...
  - title: "Data Engineering & Analytics Infrastructure"
    image: "/images/service-2.png"
    content: "Your data is only as good as the systems that power it. I design and build scalable data pipelines, warehouses, and analytics platforms so your team can focus on insights, not infrastructure."
    bulletpoints:
      - "**ETL/ELT pipelines** to consolidate data from multiple sources (APIs, databases, flat files)"
      - "**Cloud-native architectures** using AWS, GCP, or Azure for scalable, cost-efficient systems"
      - "**Data quality & monitoring** with automated validation, lineage tracking, and alerting"
      - "**BI dashboard development** with Tableau, Looker, Power BI, or custom solutions"
    button:
      enable: true
      label: "See my work"
      link: "/portfolio/"
